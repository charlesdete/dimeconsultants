      ...
      <div className="site-footer-grid">
        <div className="footer-brand">
          ...
          <div className="footer-social">
            ...
            <a href="https://x.com/" aria-label="X"><Twitter size={18} /></a>
            <a href="https://www.youtube.com/" aria-label="YouTube"><Youtube size={18} /></a>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="footer-list">
            <li><Link to="/programme" className="footer-link">AI-Ready Workforce</Link></li>
            <li><Link to="/scanner" className="footer-link">AI Readiness Scanner</Link></li>
