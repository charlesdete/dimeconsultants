      ...
      <Section>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-border bg-card p-8">
            ...
            <a href="https://calendly.com/dimeconsultants/discovery" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center gap-2 rounded-full bg-cyan px-6 py-3 font-semibold text-primary-foreground glow">
              Open Calendly
            </a>
          ...
          {/* Form */}
          <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="rounded-3xl border border-border bg-card p-8">
