  ...
  return (
    <PageLayout>
      <Section>
        ...
        <h1 className="page-title">Practical AI capability — across every function and industry.</h1>
        <p className="page-copy">
          Every engagement is customised. Whether you operate in finance, logistics, healthcare,
          manufacturing, government or the creative economy — we tailor curricula, automations and
          governance to your context.
        </p>
        <div className="responsive-grid three services-grid">
          {services.map((s) => (
            <div key={s.t} className="card service-card">
        ...
        <div className="programme-promo">
          <h2 className="section-title">Looking for a structured programme?</h2>
          <p>
            Our flagship AI-Ready Workforce Programme bundles our core training tracks with
