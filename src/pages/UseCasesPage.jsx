  ...
  return (
    <PageLayout>
      <Section>
        ...
        <h1 className="page-title">AI is industry-agnostic. The value is in the fit.</h1>
        <p className="page-copy">
          A snapshot of where we have helped organisations apply AI to drive measurable outcomes.
        </p>
        <div className="responsive-grid three use-cases-grid">
          {cases.map((c) => (
            <div key={c.t} className="card use-case-card">
