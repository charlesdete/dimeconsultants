  ...
  return (
    <PageLayout>
      <Section>
        ...
        <h1 className="page-title">Outcomes our clients can point to.</h1>
        <p className="page-copy">
          Selected engagements across industries — every programme custom-built for the team in
          the room.
        </p>
        <div className="stories-list">
          {stories.map((s) => (
            <div key={s.org} className="card story-card">
              <div>
              ...
              <div>
                ...
                <div className="story-quote">
                  <Quote size={18} className="cyan-icon" />
                  <p>"{s.quote}"</p>
                </div>
              </div>
            </div>
