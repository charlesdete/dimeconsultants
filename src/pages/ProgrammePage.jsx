  ...
  return (
    <PageLayout>
      <Section>
        ...
        <h1 className="page-title">The AI-Ready Workforce Programme</h1>
        <p className="page-copy">
          A 90-day, end-to-end transformation across five modules. Built for cohorts of 10–200
          professionals. Customised to your industry, your stack and your business outcomes.
        </p>
        <div className="responsive-grid three modules-grid">
          {modules.map((m, i) => (
            <div key={m.t} className="card module-card">
              <div className="module-card-top">
                <div className="icon-box"><m.icon size={20} /></div>
                <span className="module-number">Module 0{i + 1}</span>
              </div>
              <h3>{m.t}</h3>
              <p>{m.d}</p>
            </div>
      ...
      <section className="split-band">
        <Section>
          ...
          <h2 className="section-title">Everything to make AI stick.</h2>
          <div className="responsive-grid two included-grid">
            {[
              ...
              <div key={t} className="included-item">
      ...
      <Section>
        ...
        <div className="programme-cta">
          <Link to="/contact" className="button-primary">Enrol your team</Link>
        </div>
      </Section>
    </PageLayout>
  );
